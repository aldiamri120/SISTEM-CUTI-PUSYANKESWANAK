    ...
    <div class="auth-fluid">
                ...
                <div class="card-body">
                    ...
                    <form action="/api/login" method="POST">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" id="nip" name="nip" required placeholder="Enter NIP">
                        </div>
                        <div class="mb-3">
        ...
        <div class="auth-fluid-right text-center">
            <div class="auth-user-testimonial">
                <h2 class="mb-3"> PUSYANKESWANAK</h2>
                <p class="lead"><i class="mdi mdi-format-quote-open"></i>Your Coorporate<i class="mdi mdi-format-quote-close"></i>
                </p>
                <p>
                    <?= date('d-m-Y') ?>
                </p>
